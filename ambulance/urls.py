...
urlpatterns = [
    ...
    path('appointment/<pk>/edit/', AppointmentUpdateView.as_view(), name='appointment_edit'),
    path('appointment/<pk>/delete/', AppointmentDeleteView.as_view(), name='appointment_delete'),
